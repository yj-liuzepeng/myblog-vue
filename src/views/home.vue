        ...
        <div class="left-content">
          ...
          <div class="left-content-items" v-if="total">
            <div
              ...
              :key="item.id"
            >
              <div class="item-title" @click="toDetail(item)">
                {{ item.title }}
              </div>
              ...
              <div class="item-tags">
                ...
                <div class="item-tags-time">
                  <span
                    style="color: #fa9200"
                    class="iconfont icon-icon mr-5px"
                  ></span>
                ...
                <div class="item-tags-type">
                  <span
                    style="color: #67c23a"
                    class="iconfont icon-biaoqian1 mr-5px"
                  ></span>
                  <span
                ...
                <div class="item-tags-hot">
                  <span
                    style="color: #f56c6c"
                    class="iconfont icon-icon1 mr-5px"
                  ></span>
                  <span>{{ item.hot }}</span>
                </div>
              </div>
              ...
              <div class="item-img" @click="toDetail(item)">
                <img
                  v-lazy="'https://liuzepeng.com/' + item.pic"
                  :alt="item.title"
                />
